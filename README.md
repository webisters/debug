...
Webisters Debug Library This library is designed for reuse in Composer-based PHP applications.
...
## Installation
```bash
composer require webisters/debug
```
...
## Documentation
- Guide: https://docs.webisters.com/guides/libraries/debug/
- Package: https://webisters.com/packages/debug
...
## Support
- Issues: https://github.com/webisters/debug/issues
- Source: https://github.com/webisters/debug
